    ...
    with open(inJSON, "r") as read_file:
          ...
          for station in jsonDict['stations']:
              ...
              if station['descending']['orientation']:
                  ...
                  descending = None
              if (station['type'] == 'CREF') or (station['type'] == 'IGRS'):
                  stations.append(
              ...
              elif (station['type'] == 'CAT') or ('T' in station['type']):
                  stations.append(
                      classes.Transponder(
                          station['id'],
                          ascending,
          ...
          for stack in jsonDict['stacks']:
              stacks.append(
                  classes.Stack(
                          ...
                          stack['subswath'],
                          stack['type'],
                          sourceDir=stack['productPath'],
                          firstDate=stack['firstDate'],
                          exclDates=stack['exclDates']))    
    return stacks
